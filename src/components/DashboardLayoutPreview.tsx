...
export function DashboardLayoutPreview({ children, currentSection, onTabChange }: DashboardLayoutPreviewProps) {
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="flex items-center space-x-3 mb-6 pb-6 border-b border-gray-100">
              ...
              <div>
                ...
                <p className="text-xs text-[#e3ae61] font-medium mt-1">DEMO USER</p>
              </div>
            </div>
